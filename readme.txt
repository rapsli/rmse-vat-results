...
= 1.3.0 =
* Introducing option to display a link to the matchcenter for Hightlight of the next game
* Introducing option to display a link to a match review either statically or with a value from an ACF field

= 1.2.0 =
* Introducing templating engine for blocks, that would allow overwritting them
* Adding template legacy and modern

= 1.1.0 = 
* Adding support for ACF
* Fixing a bug in the table view

= 1.0.11 =
* Fixing folder structure for easier deployment

= 1.0.10 =
* Adding custom Block categorie for our widgets
